...
},{"./utils.js":"scripts/utils.js"}],"scripts/form.js":[function(require,module,exports) {
"use strict";
...
var formCloseBtn = document.querySelector(".close-btn--form");
var taskFormContainer = document.querySelector(".task-form-container");
var taskForm = document.querySelector("form");
var taskFormTitleInput = document.querySelector("#task-title-input");
var taskFormDescInput = document.querySelector("#task-desc-input");
var listFormTitleInput = document.querySelector("#list-title-input");
var clearFormDataAttributes = function clearFormDataAttributes() {
  taskForm.removeAttribute("data-form-type");
  taskForm.removeAttribute("data-form-list");
};
(0, _utils.addEventListenersToElements)([taskForm], "submit", function (e) {
  e.preventDefault();
  var isTaskForm = e.target.dataset.formType === "task";
  var isListForm = e.target.dataset.formType === "list";
  if (isTaskForm) {
    var taskTitle = taskFormTitleInput.value;
    var taskDesc = taskFormDescInput.value;
    if (!taskTitle || !taskDesc) return;
    (0, _board.createAndAddTask)({
      taskTitle: taskTitle,
      taskDesc: taskDesc
    }, e.target.dataset.formList);
    taskFormTitleInput.value = "";
    taskFormDescInput.value = "";
  }
  if (isListForm) {
    var listTitle = listFormTitleInput.value;
    if (!listTitle) return;
    (0, _board.createAndAddList)(listTitle);
    listFormTitleInput.value = "";
  }
  clearFormDataAttributes();
  taskFormContainer.classList.remove("task-form-container--visible");
});
(0, _utils.addEventListenersToElements)([formCloseBtn], "click", function () {
  taskFormContainer.classList.remove("task-form-container--visible");
  clearFormDataAttributes();
});
(0, _utils.attachAddBtnListener)(addBtns);
(0, _utils.attachCloseBtnEventListener)(closeBtns);
},{"./utils.js":"scripts/utils.js","./board.js":"scripts/board.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/form.js"], null)
//# sourceMappingURL=/form.ff1d4c43.js.map